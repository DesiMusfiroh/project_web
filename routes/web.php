...
//update
Route::patch('question_create_soal_satuan/{paket_soal_id}/update','QuestionController@update_soal_satuan_essay', ['$paket_soal_id' =>'paket_soal_id'])->name('updateSoalSatuan');
