        ...
        <div class="container">
            ...
            @foreach($soal_satuan as $item)
                <div class="row">
                    ...
                    <div class="col-md-2">
                    <!--Button Edit-->
                    <a href="question/update_soal_satuan/{{$paket_soal_id}}/{{$item->id}}">
                    <button class="btn btn-sm btn-primary"  style="box-shadow: 3px 2px 5px grey;"> Edit </button>
                    </a>
                   
                   <a href="#" class="btn btn-sm btn-danger hapus" style="box-shadow: 3px 2px 5px grey;">Hapus</a>
